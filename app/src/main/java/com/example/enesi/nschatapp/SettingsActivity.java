    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(galleryIntent,"Resmi Seçiniz"),GALLERY_PICK);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                mProgressDialog.setMessage("Lütfen resmin işlenmesini bekleyin !");
                ...
                filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            uploadTask.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> thumb_task) {
                                    ...
                                    {
                                        Toast.makeText(SettingsActivity.this, "Thumbnail yüklemesi başarısız !", Toast.LENGTH_LONG).show();
                                        mProgressDialog.dismiss();
                                    }
                        ...
                        {
                            Toast.makeText(SettingsActivity.this, "Yükleme başarısız !", Toast.LENGTH_LONG).show();
                            mProgressDialog.dismiss();
                        }
                    }
                });
